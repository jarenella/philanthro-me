          ...
          <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
            <div className="flex-1 overflow-y-auto py-6 px-4 sm:px-6">
              <div className="flex items-start justify-between">
                <h2 className="text-lg font-medium text-gray-900" id="slide-over-title">Donation cart</h2>
                <div className="ml-3 flex h-7 items-center">
                  <a href="/"><button type="button"  className="-m-2 p-2 text-gray-400 hover:text-gray-500">
            ...
            <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
              ...
              <div className="mt-6 flex justify-center text-center text-sm text-gray-500">
                <p>
                  or
                  <br></br>
                  <button type="button" className="font-big text-indigo-600 hover:text-indigo-500">
                     Continue Donating
